...
export declare function toPropertyObject(value: any[]): PropertyObject;
export declare function toPropertyObject(value: IObject<any>): IObject<any>;
export declare function toPropertyObject(value: string): PropertyObject | string;
