...
export declare function isInProperties(roles: IObject<any>, args: string[], isCheckTrue?: boolean): boolean;
export declare function isRole(args: string[], isCheckTrue?: boolean): boolean;
export declare function isFixed(args: string[]): boolean;
